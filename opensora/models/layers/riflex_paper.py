...
def get_1d_rotary_pos_embed_riflex(
    ...
    if use_real:
        ...
        return [freqs_cos.to(device=device, dtype=torch.bfloat16), freqs_sin.to(device=device,dtype=torch.bfloat16)]
    else:
        # lumina
...
def identify_k( b: float, d: int, N: int):
    ...
    Example:
        ...
        b=256: https://github.com/Tencent/HunyuanVideo/blob/b899c8f0041dd357c08fdb86ce8df09de8221942/hyvideo/config.py#L49
...
# print(identify_k(10000, 72, 5))
print(get_1d_rotary_pos_embed_riflex(72, 30, 10000, True, None, None))